var FALLBACK_IMAGE = "data:image/svg+xml,%3Csvg%20xmlns=%27http://www.w3.org/2000/svg%27%20width=%27200%27%20height=%27200%27%20viewBox=%270%200%20200%20200%27%3E%3Crect%20width=%27200%27%20height=%27200%27%20fill=%27%23fdf2f6%27/%3E%3Cpath%20d=%27M70%20160%20L70%2090%20L55%2090%20L100%2040%20L145%2090%20L130%2090%20L130%20160%20Z%27%20fill=%27%23d4a373%27%20opacity=%270.6%27/%3E%3Ccircle%20cx=%27100%27%20cy=%27100%27%20r=%2738%27%20fill=%27none%27%20stroke=%27%236b2d4e%27%20stroke-width=%274%27/%3E%3Ccircle%20cx=%27100%27%20cy=%27100%27%20r=%2714%27%20fill=%27%236b2d4e%27/%3E%3C/svg%3E";

var products = [];
var discounts = [];
var siteSettings = normalizeSettings(DEFAULT_SITE_SETTINGS);
var currentFilter = 'all';
var cart = normalizeCartItems(JSON.parse(localStorage.getItem('riqqa-bloom_cart') || '[]'), normalizeProducts(DEFAULT_PRODUCTS));
var deliveryMethod = localStorage.getItem('riqqa-bloom_delivery_method') || 'delivery';
...
function saveCart() {
    localStorage.setItem('riqqa-bloom_cart', JSON.stringify(normalizeCartItems(cart, products.length ? products : normalizeProducts(DEFAULT_PRODUCTS))));
}

function setDeliveryMethod(method) {
    deliveryMethod = method;
    localStorage.setItem('riqqa-bloom_delivery_method', method);
