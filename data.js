...
var BRANDS_DATA = [{ name: 'Chanel', logo: 'https://ui-avatars.com/api/?name=Chanel&background=6b2d4e&color=fff&size=64' },
    { name: 'Dior', logo: 'https://ui-avatars.com/api/?name=Dior&background=6b2d4e&color=fff&size=64' },
    { name: 'Versace', logo: 'https://ui-avatars.com/api/?name=Versace&background=6b2d4e&color=fff&size=64' },
    { name: 'Carolina Herrera', logo: 'https://ui-avatars.com/api/?name=Carolina+Herrera&background=6b2d4e&color=fff&size=64' },
    { name: 'Yves Saint Laurent', logo: 'https://ui-avatars.com/api/?name=Yves+Saint+Laurent&background=6b2d4e&color=fff&size=64' },
    { name: 'Calvin Klein', logo: 'https://ui-avatars.com/api/?name=Calvin+Klein&background=6b2d4e&color=fff&size=64' },
    { name: 'Hugo Boss', logo: 'https://ui-avatars.com/api/?name=Hugo+Boss&background=6b2d4e&color=fff&size=64' },
    { name: 'The Ordinary', logo: 'https://ui-avatars.com/api/?name=The+Ordinary&background=6b2d4e&color=fff&size=64' },
    { name: 'La Roche-Posay', logo: 'https://ui-avatars.com/api/?name=La+Roche-Posay&background=6b2d4e&color=fff&size=64' },
    { name: 'CeraVe', logo: 'https://ui-avatars.com/api/?name=CeraVe&background=6b2d4e&color=fff&size=64' },
    { name: 'Neutrogena', logo: 'https://ui-avatars.com/api/?name=Neutrogena&background=6b2d4e&color=fff&size=64' },
    { name: 'L'Oreal', logo: 'https://ui-avatars.com/api/?name=L%27Oreal&background=6b2d4e&color=fff&size=64' },
    { name: 'Bath & Body Works', logo: 'https://ui-avatars.com/api/?name=Bath+%26+Body+Works&background=6b2d4e&color=fff&size=64' },
    { name: 'Nivea', logo: 'https://ui-avatars.com/api/?name=Nivea&background=6b2d4e&color=fff&size=64' },
    { name: 'Victoria's Secret', logo: 'https://ui-avatars.com/api/?name=Victoria%27s+Secret&background=6b2d4e&color=fff&size=64' },
    { name: 'L'Occitane', logo: 'https://ui-avatars.com/api/?name=L%27Occitane&background=6b2d4e&color=fff&size=64' },
    { name: 'MAC', logo: 'https://ui-avatars.com/api/?name=MAC&background=6b2d4e&color=fff&size=64' },
    { name: 'Estee Lauder', logo: 'https://ui-avatars.com/api/?name=Estee+Lauder&background=6b2d4e&color=fff&size=64' },
    { name: 'Huda Beauty', logo: 'https://ui-avatars.com/api/?name=Huda+Beauty&background=6b2d4e&color=fff&size=64' },
    { name: 'Maybelline', logo: 'https://ui-avatars.com/api/?name=Maybelline&background=6b2d4e&color=fff&size=64' },
    { name: 'Dolce & Gabbana', logo: 'https://ui-avatars.com/api/?name=Dolce+%26+Gabbana&background=6b2d4e&color=fff&size=64' },
    { name: 'Jimmy Choo', logo: 'https://ui-avatars.com/api/?name=Jimmy+Choo&background=6b2d4e&color=fff&size=64' },
    { name: 'Riqqa', logo: 'https://ui-avatars.com/api/?name=Riqqa&background=6b2d4e&color=fff&size=64' }];
